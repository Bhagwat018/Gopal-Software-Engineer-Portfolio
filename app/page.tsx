...
const ContactButton = () => {
  ...
  const openGmail = () => {
    const email = 'gopalbhagwat21@gmail.com';
  ...
  return (
    <div className={` transition-colors duration-300 ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-black'
      ...
      <main className="flex flex-col md:flex-row  w-full max-w-7xl mx-auto flex-cole md:flex-row py-10 px-6 md:px-16">
        ...
        >
          <Image src="/images/homeBoy.png" alt="Profile" width={300} height={300} className="w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full" />
        </motion.div>
      </main>
    </div>
  );
