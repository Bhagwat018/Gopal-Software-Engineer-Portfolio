...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append("access_key", "49c67d9b-259c-44cb-a85e-3f845acda4f0");
      ...
      >
        ...
        <main className="flex w-full max-w-7xl mx-auto py-10 px-6 md:px-16 flex-col md:flex-row gap-10">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>Email: gopalbhagwat21@gmail.com</p>
                <p>Phone: +91 6267957589</p>
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <Image src="/images/profileBoyLogo.png" alt="Contact" className="w-full h-auto" width={500} height={500} />
          </motion.div>
        </main>
      </motion.div>
    </div>
